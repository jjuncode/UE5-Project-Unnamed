...
constexpr SkillId SkillId_MIN = SKILL_INFO_NONE;
constexpr SkillId SkillId_MAX = SKILL_INFO_KICK;
...
enum ActionState : int {
  ACTION_STATE_NONE = 0,
  ACTION_STATE_MOVE = 1,
  ACTION_STATE_BATTLE = 2,
  ACTION_STATE_ATTACK_TRY = 3,
  ACTION_STATE_ATTACK_SUCCESS = 4,
  ACTION_STATE_ATTACK_INTERRUPTED = 5,
  ACTION_STATE_PARRY = 6,
  ACTION_STATE_DAMAGED = 7,
